<template>
  <div class="entry-container mb-3 pointer p-2" @click="$router.push({name: 'entry', params: {id: 10}})">
    ...
    <div class="entry-description">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, corrupti. Esse, velit, deleniti iusto obcaecati sunt nulla harum quod veniam nihil, inventore neque non magnam iure atque ratione consequuntur qui?
    </div>
  </div>
</template>
