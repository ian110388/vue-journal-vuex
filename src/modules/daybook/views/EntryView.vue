<template>
  <div class="entry-title d-flex justify-content-between p-2">
    <div>
        ...
        <span class="text-success fs-4 fw-light">2021, Jueves</span>
    </div>
    <div>
  ...
  <Fab icon="fa-save"/>
  <img src="https://www.turimexico.com/wp-content/uploads/2016/06/Cascada-de-Basaseachi-en-Chihuahua.jpg" alt="entry-picture" class="img-thumbnail">
</template>
...
export default {
    components: {
        Fab: defineAsyncComponent(() => import('../components/Fab-component.vue'))
    }
}
</script>
